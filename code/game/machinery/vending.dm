...
/obj/machinery/vending/Initialize(mapload)
	...
	if(refill_canister)
		...
		V.set_type(type)
		component_parts += V
		component_parts += new refill_canister(null)
		RefreshParts()
	. = ..()
	wires = new(src)
...
/obj/machinery/vending/security
	...
	products = list(/obj/item/restraints/handcuffs = 8,/obj/item/restraints/handcuffs/cable/zipties = 8,/obj/item/grenade/flashbang = 4,/obj/item/flash = 5,
					...
					/obj/item/clothing/mask/muzzle/safety = 4, /obj/item/storage/box/swabs = 6, /obj/item/storage/box/fingerprints = 6, /obj/item/eftpos/sec = 4, /obj/item/body_camera = 10)
